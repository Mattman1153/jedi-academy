...
void G_WriteClientSessionData( gclient_t *client ) {
	...
	s = va("%i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %s %s %s", 
		...
		client->sess.loggedinknight,
		client->sess.ip[0],
		client->sess.ip[1],
		client->sess.ip[2],
		client->sess.ip[3],
		client->sess.warnLevel,
		siegeClass,
		saberType,
		saber2Type
		);
...
void G_ReadSessionData( gclient_t *client ) {
	...
	sscanf( s, "%i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %i %s %s %s",
...
void G_InitSessionData( gclient_t *client, char *userinfo, qboolean isBot ) {
	...
	// MJN - Write data
	sess->startShowMOTD = qfalse;
	sess->loggedinadmin = qfalse;
	sess->loggedinknight = qfalse;
