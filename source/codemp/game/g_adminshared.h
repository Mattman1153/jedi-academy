...
static adminTable_t passthroughfuncs[] = { 
	...
	{"amtele", "mtele", "<playerid> <x> <y> <z> <yaw>\n", 5, ADMIN_TELE, "^3Teleports player to a specified location"},
...
qboolean duel_overtime; // lmo - indicates that the timelimit of the level has been extended
