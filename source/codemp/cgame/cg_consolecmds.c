...
void CG_InitConsoleCommands( void ) {
	...
	trap_AddCommand ("loaddeferred");	// MJN - Corrected // spelled wrong, but not changing for demo

// MJN - Adding these so the server recognizes the command without typing a "\" before the command.
#ifdef JAE_MOD
	// MJN - Admin Command entry.
	trap_AddCommand ("amlogin");
	trap_AddCommand ("amlogout");
	trap_AddCommand ("aminfo");
	trap_AddCommand ("amhelp");
	trap_AddCommand ("amsay");
	trap_AddCommand ("amwhois");
	trap_AddCommand ("amstatus");
	trap_AddCommand ("ignore");

	trap_AddCommand ("amkick");
	trap_AddCommand ("amkickban");
	trap_AddCommand ("amsilence");
	trap_AddCommand ("amunsilence");
	trap_AddCommand ("amempower");
	trap_AddCommand ("amunempower");
	trap_AddCommand ("amterminator");
	trap_AddCommand ("amunterminator");
	trap_AddCommand ("amprotect");
	trap_AddCommand ("amunprotect");
	trap_AddCommand ("amsleep");
	trap_AddCommand ("amwake");
	trap_AddCommand ("amrename");
	trap_AddCommand ("amshowmotd");
	trap_AddCommand ("ampsay");
	trap_AddCommand ("ambanrange");
	trap_AddCommand ("amtele");
	trap_AddCommand ("amorigin");
	trap_AddCommand ("amnotarget");
	trap_AddCommand ("amforceteam");
	trap_AddCommand ("amallowvote");
	trap_AddCommand ("amdenyvote");
	trap_AddCommand ("amlockteam");
	trap_AddCommand ("amunlockteam");
	trap_AddCommand ("amvstr");
	trap_AddCommand ("amgametype");
	trap_AddCommand ("amnextmap");
	trap_AddCommand ("amrandteams");
	trap_AddCommand ("amslap");
	trap_AddCommand ("amnpcaccess");
	trap_AddCommand ("amtimescale");
	trap_AddCommand ("amwarn");
	trap_AddCommand ("amforgive");
	
	// MJN - Emote Command entry
	trap_AddCommand ("emsit");
	trap_AddCommand ("emsit2");
	trap_AddCommand ("emsit3");
	trap_AddCommand ("emsit4");
	trap_AddCommand ("emsit5");
	trap_AddCommand ("emsit6");
	trap_AddCommand ("emwait");
	trap_AddCommand ("emsurrender");
	trap_AddCommand ("emsorrow");
	trap_AddCommand ("emhonor");
	trap_AddCommand ("emnod");
	trap_AddCommand ("emshake");
	trap_AddCommand ("empraise");
	trap_AddCommand ("emattenhut");
	trap_AddCommand ("emcrossarms");
	trap_AddCommand ("emalora");
	trap_AddCommand ("emthrow");
	trap_AddCommand ("emtavion");
	trap_AddCommand ("empoint");
	trap_AddCommand ("emcomeon");
#endif
}
